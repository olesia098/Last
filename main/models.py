...
class BooksDescription(models.Model):
    ...
    speaker = models.ForeignKey(Speaker, related_name='speaker', on_delete=models.CASCADE)
...
class Comment(models.Model):
    ...
    title = models.ForeignKey(BooksDescription, related_name='titles', on_delete=models.CASCADE)
